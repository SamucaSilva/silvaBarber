...
public class UsuarioDAO implements IDAO_T<Usuario> {
    ...
    public String salvar(Usuario o) {
        ...
        try {
            String sql = ""
                    + "INSERT INTO usuario (usuario, senha, situacao) VALUES ("
                    + "'" + o.getNome() + "',"
                    + "md5('" + o.getSenha() + "'),"
                    + "'" + o.getSituacao() + "' "
                    + ")";
    ...
    public ArrayList<Usuario> consultarTodos() {
        ...
        try {
            ...
            while (resultadoQ.next()) {
                ...
                usuario.setNome(resultadoQ.getString("usuario"));
    ...
    public Usuario consultarId(int id) {
        ...
        try {
            ...
            if (resultadoQ.next()) {
                ...
                u.setId(id);
                u.setNome(resultadoQ.getString("usuario"));
    ...
    public Usuario login(String nome, String senha) {
        ...
        try {
            String sql = ""
                    + "SELECT * FROM usuario "
                    + "WHERE  "
                    + "usuario = '" + nome + "' AND senha = md5('" + senha + "') "
                    + "AND situacao = 'A'";
            ...
            if (resultadoQ.next()) {
                ...
                i.setNome(resultadoQ.getString("usuario"));
